...
<p>A <b>phase</b> is a region of material with uniform structure and composition. <b>Microstructure</b> describes how phases are distributed — their size, shape and arrangement. Two samples with identical phases can have very different properties if the microstructure differs. Phase diagrams map which phases are stable at each composition and temperature; the next topic develops how to read them.</p>"""),
],
6: [
